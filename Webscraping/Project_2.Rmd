...
```{r libraries_path, message=FALSE, warning=FALSE}
# Libraries used
library(readxl)
library(RSelenium)
library(rvest)
...
root <- "C:/Users/iorueta/PC IGNACIO/0.LSE/MPA DSPP/1. Autumm Term 2024/MY472 Data for Data Scientists/Problem Sets/PS3 (50%)/my472-at24-final-IgnacioOrueta"
ddir <- "C:/Users/iorueta/PC IGNACIO/0.LSE/MPA DSPP/1. Autumm Term 2024/MY472 Data for Data Scientists/Problem Sets/PS3 (50%)/my472-at24-final-IgnacioOrueta/data"
odir <- "C:/Users/iorueta/PC IGNACIO/0.LSE/MPA DSPP/1. Autumm Term 2024/MY472 Data for Data Scientists/Problem Sets/PS3 (50%)/my472-at24-final-IgnacioOrueta/outputs"
...
```{r scrape_Google_Maps, eval=FALSE, message=FALSE, warning=FALSE}
...
```{r cleaning Google Maps, eval=FALSE}
# Note: I wrote eval=FALSE because I didn't run the scrape when knitting.
...
```{r cleaning RightMove, eval=FALSE}
# Note: I wrote eval=FALSE because I didn't run the scrape when knitting.
...
```{r Importing GIS, message=FALSE, warning=FALSE}
# GIS boundary London
...
```{r competition_plot, warning=FALSE}
